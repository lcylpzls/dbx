...
- `TraceHook` / `TraceAttr` 契约迁移至零依赖子模块
  `tracex/contract`（v1.0.0），dbx 不再依赖 tracex 主模块。
...
- README / docs 与当前代码同步：版本状态、架构与性能文档更新；
- 清理过期规划文档（PRD/api-design/decisions/iteration-plan 等）与历史 API 快照。
...
- 公开子包 mysql/pg/sqlite/confx/migrate 保持不变。
...
- 依赖升级：tracex v1.0.4、metricsx v1.5.4、confx v1.0.4、errx v1.5.7、logx v1.3.4、validx v1.2.5、testx v1.4.5 及 modernc/三方最新版本。
